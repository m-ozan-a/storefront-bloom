...
import type { StorefrontManifest } from '@/lib/owuan/manifest';
...
interface BloomCollectionShowcaseProps {
  collections: CollectionItem[];
}

export function BloomCollectionShowcase({ collections }: BloomCollectionShowcaseProps) {
  ...
  return (
    <section className="pt-24 pb-32 md:pb-48 bg-card">
      <div className="content-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:h-[800px]">
          <Link
            href={`/search?collection=${firstCollection.slug}`}
            className="group relative overflow-hidden bg-muted aspect-[3/4] lg:aspect-auto lg:h-full"
          >
            <img
